...
| --- | --- | --- | --- |
| 1 | [#12 — Settings screen redesign, theme preview picker and open-source licence fetch](https://github.com/openMF/mifos-x-open-banking/pull/12) | [MXOBA-91](https://mifosforge.jira.com/browse/MXOBA-91), [MXOBA-92](https://mifosforge.jira.com/browse/MXOBA-92) | Rebuilds settings as elevated grouped cards on `KptTheme` + `DesignToken`, and replaces the theme dropdown with three preview cards drawn from the light and dark palettes. Adds the open-source licence layer — network, Store5 with a 24h TTL, preference-backed source of truth — and a licences screen that fetches the text instead of bundling it. |
| 2 | [#11 — UI rework](https://github.com/openMF/mifos-x-open-banking/pull/11) | [MXOBA-90](https://mifosforge.jira.com/browse/MXOBA-90) | Introduces `DesignToken` and the `Mifos*` primitives, and moves every feature onto the shared components. Consolidates the account and payee models onto core types, collapsing the account identifier and type onto `identification` + `accountTypeCode`. Rebuilds home as the account and payment hub, drops the navigation rail, and reworks how accounts, parties and payment status are displayed. |
| 3 | [#10 — Standing orders and Variable Recurring Payments](https://github.com/openMF/mifos-x-open-banking/pull/10) | [MXOBA-68](https://mifosforge.jira.com/browse/MXOBA-68), [MXOBA-83](https://mifosforge.jira.com/browse/MXOBA-83), [MXOBA-84](https://mifosforge.jira.com/browse/MXOBA-84), [MXOBA-85](https://mifosforge.jira.com/browse/MXOBA-85) | Adds standing orders as the third payment flow (domestic + international rails) — recurring payments with frequency, first/final amounts and optional end date — and **Variable Recurring Payments** end-to-end: one-time consent with per-period control parameters, then single-screen payments checked against the limits. |
| 4 | [#8 — Scheduled payments - International and Domestic](https://github.com/openMF/mifos-x-open-banking/pull/8) | [MXOBA-79](https://mifosforge.jira.com/browse/MXOBA-79), [MXOBA-82](https://mifosforge.jira.com/browse/MXOBA-82) | Schedules a payment for a future date on both OBIE scheduled rails (domestic + international), reached from the Schedule card on the Payments Hub. |
...
https://github.com/user-attachments/assets/ad235128-6821-40d5-97df-3f354be3a1e2
